              ...
              emxArray_real_T *pp_breaks, emxArray_real_T *pp_coefs)
{
  ...
  if (x->size[1] <= 2) {
    if (has_endslopes) {
      ...
      i6 = pp_breaks->size[0] * pp_breaks->size[1];
      pp_breaks->size[0] = 1;
      pp_breaks->size[1] = s->size[1];
      emxEnsureCapacity((emxArray__common *)pp_breaks, i6, (int)sizeof(double));
      k = s->size[0] * s->size[1];
      for (i6 = 0; i6 < k; i6++) {
        pp_breaks->data[i6] = s->data[i6];
      }

      emxFree_real_T(&s);
      i6 = pp_coefs->size[0] * pp_coefs->size[1] * pp_coefs->size[2];
      pp_coefs->size[0] = 1;
      pp_coefs->size[1] = 4;
      pp_coefs->size[2] = 1;
      emxEnsureCapacity((emxArray__common *)pp_coefs, i6, (int)sizeof(double));
      for (i6 = 0; i6 < 4; i6++) {
        pp_coefs->data[i6] = t2_coefs[i6];
      }
    } else {
      emxInit_real_T(&s, 2);
      ...
      s->size[0] = 1;
      s->size[1] = k;
      emxEnsureCapacity((emxArray__common *)s, i6, (int)sizeof(double));
      for (i6 = 0; i6 < k; i6++) {
        s->data[s->size[0] * i6] = x->data[i6];
      }
    ...
    if ((x->size[1] == 3) && (!has_endslopes)) {
      ...
      emxEnsureCapacity((emxArray__common *)pp_breaks, i6, (int)sizeof(double));
      for (i6 = 0; i6 < 2; i6++) {
        pp_breaks->data[pp_breaks->size[0] * i6] = c_data[i6];
      }
      ...
      for (i6 = 0; i6 < k; i6++) {
        pp_breaks->data[i6] = t0_breaks->data[i6];
      }
      ...
      for (i6 = 0; i6 < k; i6++) {
        pp_coefs->data[i6] = t0_coefs->data[i6];
      }
    }
