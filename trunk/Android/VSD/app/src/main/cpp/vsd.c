 ...
 * sample rate anyway
 * Arguments    : JNIEnv env JNI environment
 * Arguments    : jobject obj jObject
 * Arguments    : JdoubleArray jInput
 * Return Type  : double
 */
JNIEXPORT jdouble JNICALL Java_com_nfsindustries_vsd_Realtime_vsd(JNIEnv * env, jobject obj, jdoubleArray jInput)
{
  ...
  (*env)->ReleaseDoubleArrayElements(env,jInput,input,JNI_ABORT);
