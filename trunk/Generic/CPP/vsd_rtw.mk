...
## 
## Makefile     : vsd_rtw.mk
## Generated on : Wed Dec 21 23:52:55 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/vsd.a
...
MAKEFILE                  = vsd_rtw.mk
COMPUTER                  = MACI64
MATLAB_ROOT               = /Applications/MATLAB/MATLAB_R2016b.app
MATLAB_BIN                = /Applications/MATLAB/MATLAB_R2016b.app/bin
MATLAB_ARCH_BIN           = /Applications/MATLAB/MATLAB_R2016b.app/bin/maci64
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/maxmousee/repo/Stress-Detector/trunk/Generic/MATLAB
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/vsd.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/vsd -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=vsd -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/vsd/vsd_initialize.cpp $(START_DIR)/codegen/lib/vsd/vsd_terminate.cpp $(START_DIR)/codegen/lib/vsd/vsd.cpp $(START_DIR)/codegen/lib/vsd/emd.cpp $(START_DIR)/codegen/lib/vsd/findpeaks.cpp $(START_DIR)/codegen/lib/vsd/diff.cpp $(START_DIR)/codegen/lib/vsd/sum.cpp $(START_DIR)/codegen/lib/vsd/abs.cpp $(START_DIR)/codegen/lib/vsd/spline.cpp $(START_DIR)/codegen/lib/vsd/pwchcore.cpp $(START_DIR)/codegen/lib/vsd/bsearch.cpp $(START_DIR)/codegen/lib/vsd/power.cpp $(START_DIR)/codegen/lib/vsd/fft.cpp $(START_DIR)/codegen/lib/vsd/vsd_emxutil.cpp $(START_DIR)/codegen/lib/vsd/rt_nonfinite.cpp $(START_DIR)/codegen/lib/vsd/rtGetNaN.cpp $(START_DIR)/codegen/lib/vsd/rtGetInf.cpp
...
%.o : $(START_DIR)/codegen/lib/vsd/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/vsd/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
