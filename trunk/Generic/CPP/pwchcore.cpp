                ...
                *pp_coefs)
{
  ...
  i7 = pp_coefs->size[0] * pp_coefs->size[1] * pp_coefs->size[2];
  pp_coefs->size[0] = 1;
  pp_coefs->size[1] = szc_idx_1;
  pp_coefs->size[2] = 4;
  emxEnsureCapacity((emxArray__common *)pp_coefs, i7, (int)sizeof(double));
              ...
              s[2], emxArray_real_T *pp_breaks, double pp_coefs[4])
{
  ...
  for (i6 = 0; i6 < x_idx_0; i6++) {
    pp_breaks->data[pp_breaks->size[0] * i6] = x->data[i6];
  }
