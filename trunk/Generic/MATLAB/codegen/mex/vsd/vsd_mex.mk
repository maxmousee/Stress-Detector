START_DIR = C:\Users\maxmo\repo\STRESS~1\trunk\Generic\MATLAB
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\vsd"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\vsd/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
