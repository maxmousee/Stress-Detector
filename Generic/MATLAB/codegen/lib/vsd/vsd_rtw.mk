...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/maxmouse/repo/Stress-Detector/Generic/MATLAB
ARCH                      = maci64
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/vsd -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
OBJS = vsd_initialize.o vsd_terminate.o vsd.o emd.o findpeaks.o diff.o sum.o abs.o spline.o pwchcore.o power.o fft.o fft1.o bluesteinSetup.o vsd_emxutil.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
